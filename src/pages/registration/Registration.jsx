          ...
          {({ values, errors, touched, handleBlur, handleChange, handleSubmit }) => (
            <form onSubmit={handleSubmit}>
              <SectionRegistration>
                ...
                <InputField type="text" name="username" onBlur={handleBlur} onChange={handleChange} placeholder="..." />
                <ErrorMessage>
                ...
                />
                <ErrorMessage>{errors.email && touched.email ? <Error>{errors.email}</Error> : null}</ErrorMessage>
                <LabelField>
                  Password
                  <Star>*</Star>
                </LabelField>
                ...
                />
                <ErrorMessage>
                  {errors.repeat_password && touched.repeat_password ? <Error>{errors.repeat_password}</Error> : null}
                </ErrorMessage>
